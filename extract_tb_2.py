...
path = "/data/uavlab/multi-uav-pursuit2/runs/HideAndSeek_20260326_163903/events.out.tfevents.1774514343.uavlab.2438900.0"
...
metrics_to_check = [
    ...
    "train/stats.coop_reward", "train/stats.phi_team", "train/stats.d_i_mean", "train/stats.target_predicted_error",
    "train/stats.collision_drone", "train/stats.pursuer_collisions_count", "train/stats.collision_floor",
    "train/stats.collision_penalty", "train/stats.speed_reward", "train/stats.goal_reached",
...
for tag in ea.Tags()['scalars']:
    if tag in metrics_to_check or any(m in tag for m in ['success', 'reward', 'loss', 'entropy', 'collision', 'log_std']):
