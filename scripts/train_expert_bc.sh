...
CLOSE_WEIGHT_MULT="${CLOSE_WEIGHT_MULT:-1.0}"
NEAR_DIST_REWEIGHT="${NEAR_DIST_REWEIGHT:-false}"
ACTION_DIM_WEIGHTS="${ACTION_DIM_WEIGHTS:-1,1,1,1}"
...
CMD=(
    ...
    --close_weight_mult="${CLOSE_WEIGHT_MULT}"
    --near_dist_reweight="${NEAR_DIST_REWEIGHT}"
